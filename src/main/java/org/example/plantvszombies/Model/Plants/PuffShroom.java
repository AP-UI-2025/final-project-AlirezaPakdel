...
public class PuffShroom extends WarriorPlant {
    public PuffShroom(double row, double col , int x , int y) {
        super(0, "puffShroom", 5, 4, BulletType.Smoke, x, y);

        Image image = new Image(getClass().getResource("/images/puff_ShroomRelax.gif").toExternalForm());
