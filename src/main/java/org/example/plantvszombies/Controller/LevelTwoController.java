...
import org.example.plantvszombies.Model.Plants.Repeater;
import org.example.plantvszombies.Model.Plants.SnowPea;
...
public class LevelTwoController implements Initializable {
    ...
    private enum PlantType {SNOWPEA , REPEATER ,  PEASHOOTER, SUNFLOWER , NONE}
