...
import org.example.plantvszombies.Model.Zombies.ScreenDoorZombie;
...
public class NightLevelTwoController implements Initializable {
    ...
    private enum PlantType {FUMESHROOM , ICESHROOM , PUFFSHROMM, SUNSHROOM , NONE}
    ...
    public void initialize(URL location, ResourceBundle resources) {
        ...
        plantBar.getChildren().addAll(puffShroomIcon, sunShroomIcon , FumeIcon, IceIcon);
